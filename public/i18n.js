...
(function () {
  ...
  var ES = {
    ...
    // ── Essay / card: "A Man, a Plan, a Canal" (title fragments left untranslated on purpose —
    // graceful English fallback, matching how film/show titles stay in English elsewhere) ──
    ...
    "A famous palindrome once described Panama to the world as the site of a maritime shortcut. Those days are just the beginning: Panama is now a recognized air, maritime and communications hub for the Americas — and one of the most reliable places in the world to shoot.": "Un famoso palíndromo describió alguna vez a Panamá ante el mundo como el sitio de un atajo marítimo. Esos días son solo el comienzo: Panamá es hoy un hub aéreo, marítimo y de comunicaciones reconocido para las Américas — y uno de los lugares más confiables del mundo para rodar.",
    "The Hub of the Americas": "El Hub de las Américas",
    "Panama connects 90+ cities across the Americas and Europe with daily direct flights, and five percent of global maritime trade transits the canal, with weekly service from major US, South American, Asian and European ports. Intercontinental undersea cable systems carry true broadband, and the banking system is pegged to the US dollar — safe, fast money transfers with no currency exchange to manage. Whatever a production can't source locally, Panama can get here fast.": "Panamá conecta más de 90 ciudades en América y Europa con vuelos directos diarios, y el cinco por ciento del comercio marítimo mundial transita por el canal, con servicio semanal desde los principales puertos de EE. UU., Sudamérica, Asia y Europa. Los sistemas de cable submarino intercontinental cargan banda ancha real, y el sistema bancario está anclado al dólar estadounidense — transferencias de dinero seguras y rápidas, sin cambio de divisa que gestionar. Lo que una producción no pueda conseguir localmente, Panamá lo trae rápido.",
    "Proven on screen, on location": "Comprobado en pantalla, en locación",
    "Bocas del Toro, Pearl Islands, Pedasí and Chiriquí have hosted Amazing Race (USA, Canada, Australia and Finland), Survivor, MTV's The Challenge three times over, Discovery's Survive the Raft, NBC's Deal or No Deal Island, and a run of YouTube creators including MrBeast and N3ON. Scripted work goes further: the Bond franchise used Panama to double for Bolivia and Haiti in Quantum of Solace, The Suicide Squad turned a derelict stretch of Colón into the fictional island of Corto Maltese, and Prison Break and Contraband both used Panama as itself. Beaches, deserted islands, mountains, tropical jungle, raging rivers and waterfalls, luxury builds, barracks and former military bases, and a modern capital with every barrio and urban niche a script could ask for — that range is the whole case.": "Bocas del Toro, las Islas Perlas, Pedasí y Chiriquí han sido sede de Amazing Race (EE. UU., Canadá, Australia y Finlandia), Survivor, The Challenge de MTV en tres ocasiones, Survive the Raft de Discovery, Deal or No Deal Island de NBC, y una serie de creadores de YouTube entre ellos MrBeast y N3ON. El trabajo de ficción va más allá: la franquicia de Bond usó Panamá para doblar como Bolivia y Haití en Quantum of Solace, The Suicide Squad convirtió un tramo abandonado de Colón en la isla ficticia de Corto Maltese, y Prison Break y Contraband usaron Panamá como Panamá. Playas, islas desiertas, montañas, selva tropical, ríos y cascadas embravecidas, construcciones de lujo, cuarteles y antiguas bases militares, y una capital moderna con cada barrio y nicho urbano que un guion pueda pedir — ese rango es todo el argumento.",
    "Responsible by law, not just by choice": "Responsable por ley, no solo por elección",
    "Panama is one of only three carbon-negative countries in the world, alongside Bhutan and Suriname. We encourage productions to cut single-use plastic bottles from set, and Panama's flora and fauna protection laws apply to every production working here — we'll walk you through what they mean for your shoot.": "Panamá es uno de solo tres países carbono-negativos en el mundo, junto con Bután y Surinam. Animamos a las producciones a eliminar las botellas plásticas de un solo uso del set, y las leyes de protección de flora y fauna de Panamá aplican a toda producción que trabaje aquí — te explicamos qué significan para tu rodaje.",
    "Climate at a glance": "El clima de un vistazo",
    "Dry season runs late December to April; rain builds from May and peaks in September and October, but downpours are fast — a dark afternoon sky can clear to a bright, magic-hour sunset within the hour. Being this close to the equator means almost exactly 12 hours of daylight year-round, no daylight saving to plan around. Expect upper-20s to mid-30s°C and humidity in the mid-80s.": "La estación seca va de finales de diciembre a abril; la lluvia aumenta desde mayo y llega a su punto máximo en septiembre y octubre, pero los aguaceros son rápidos — un cielo oscuro de tarde puede despejar a un atardecer luminoso de magic hour en cuestión de una hora. Estar tan cerca del ecuador significa casi exactamente 12 horas de luz todo el año, sin horario de verano que planificar. Espera temperaturas entre los 27 y 35°C, con humedad alrededor del 80-85%.",
    "The 25% rebate, the fine print": "El rebate del 25%, la letra chica",
    "Film Law 16 pays back 25% in cash on a minimum in-country spend of $500,000, filed through a locally licensed production partner registered with both the Ministry of Culture and the Ministry of Commerce and Industries. It comes with customs exemptions and a single-window stop for customs and labor permits, and every import brought in temporarily for the shoot is duty-free. The paperwork has to run through a certified public accountant and legal counsel — we handle both. One line item worth budgeting for: the Panama Film Commission charges $150 per week of production starting in preproduction, which counts toward the 25% cash back.": "La Ley de Cine 16 devuelve el 25% en efectivo sobre un gasto mínimo en el país de $500,000, presentado a través de un socio de producción local licenciado y registrado ante el Ministerio de Cultura y el Ministerio de Comercio e Industrias. Viene con exenciones de aduana y una ventanilla única para trámites de aduana y permisos laborales, y todo equipo importado temporalmente para el rodaje está libre de aranceles. El papeleo debe pasar por un contador público autorizado y asesoría legal — nosotros manejamos ambos. Una línea que vale la pena presupuestar: la Comisión de Cine de Panamá cobra $150 por semana de producción desde la preproducción, monto que cuenta para el 25% de reembolso.",
    "On the ground": "En terreno",
    "GMT-5 year-round, no daylight saving. Sales tax is 7% on goods and services. Power runs 120V with US-style outlets, so nothing extra to pack. The balboa pegs 1:1 to the US dollar, and dollar bills circulate freely and legally. Learn one phrase — ¿Qué xopa? — and leave time to try seco, Ron Abuelo, patacones, a raspao, Panamanian coffee, and Sunday \"Chinese breakfast,\" a uniquely Panamanian tradition however you slice it. And don't skip the Canal — it never gets old.": "GMT-5 todo el año, sin horario de verano. El impuesto de ventas es 7% sobre bienes y servicios. La corriente es de 120V con enchufes tipo estadounidense, así que no hay que empacar nada extra. El balboa está anclado 1:1 al dólar estadounidense, y los billetes de dólar circulan libre y legalmente. Aprende una frase — ¿Qué xopa? — y saca tiempo para probar seco, Ron Abuelo, patacones, un raspao, café panameño, y el \"desayuno chino\" de domingo, una tradición panameña como ninguna otra. Y no te pierdas el Canal — nunca deja de sorprender.",
    "Who we've worked with": "Con quién hemos trabajado",
    "Established in 1993, Verite Producciones has run production services for CBS, NBC, MTV, Discovery, Netflix, FOX Television, E! Entertainment, Bunim-Murray Productions, Critical Content, Bright Bay Creative, World Race Productions, MrBeast LLC and nearly every local advertising agency — bilingual crew, location scouting, marine, air and land transport, legal services and catering, plus the legal team to process every benefit under Film Law 16.": "Fundada en 1993, Verite Producciones ha brindado servicios de producción a CBS, NBC, MTV, Discovery, Netflix, FOX Television, E! Entertainment, Bunim-Murray Productions, Critical Content, Bright Bay Creative, World Race Productions, MrBeast LLC y prácticamente todas las agencias de publicidad locales — crew bilingüe, scouting de locaciones, transporte marítimo, aéreo y terrestre, servicios legales y catering, además del equipo legal para tramitar cada beneficio bajo la Ley de Cine 16.",

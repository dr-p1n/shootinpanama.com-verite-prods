...
(function () {
  ...
  var ES = {
    ...
    "Panama plays elsewhere, too": "Panamá también hace de otros lugares",
    "The Bond franchise shot Quantum of Solace here, using Panama to double for Bolivia and Haiti. The Suicide Squad turned a derelict stretch of Colón into the fictional island of Corto Maltese. Prison Break and Contraband both used Panama as itself. That range is the whole case: beaches, deserted islands, mountains, tropical jungle, raging rivers and waterfalls, luxury builds, barracks and former military bases, and a modern capital with every barrio and urban niche a script could ask for.": "La franquicia de Bond rodó aquí Quantum of Solace, usando Panamá para doblar como Bolivia y Haití. The Suicide Squad convirtió un tramo abandonado de Colón en la isla ficticia de Corto Maltese. Prison Break y Contraband usaron Panamá como Panamá. Ese rango es todo el argumento: playas, islas desiertas, montañas, selva tropical, ríos y cascadas embravecidas, construcciones de lujo, cuarteles y antiguas bases militares, y una capital moderna con cada barrio y nicho urbano que un guion pueda pedir.",
    ...
    "It's not just flights. Five percent of global maritime trade transits the canal, with weekly service from major US, South American, Asian and European ports. Intercontinental undersea cable systems carry true broadband, and the banking system is pegged to the US dollar — safe, fast money transfers with no currency exchange to manage. Whatever a production can't source locally, Panama can get here fast.": "No es solo cuestión de vuelos. El cinco por ciento del comercio marítimo mundial transita por el canal, con servicio semanal desde los principales puertos de EE. UU., Sudamérica, Asia y Europa. Los sistemas de cable submarino intercontinental cargan banda ancha real, y el sistema bancario está anclado al dólar estadounidense — transferencias de dinero seguras y rápidas, sin cambio de divisa que gestionar. Lo que una producción no pueda conseguir localmente, Panamá lo trae rápido.",
    "Why producers come back": "Por qué los productores regresan",
    "CBS's The Amazing Race, Discovery's Survive the Raft, MTV's The Challenge, Netflix, NBC's Today Show, NBC's Deal or No Deal Island, four MrBeast productions and creators like N3ON have all shot here with the same ground team. The continuity is the point: the crew that scouts your location clears your permits and runs your days.": "The Amazing Race de CBS, Survive the Raft de Discovery, The Challenge de MTV, Netflix, el Today Show de NBC, Deal or No Deal Island de NBC, cuatro producciones de MrBeast y creadores como N3ON han rodado aquí con el mismo equipo en tierra. La continuidad es el punto: el crew que hace el scouting de tu locación tramita tus permisos y maneja tus días.",

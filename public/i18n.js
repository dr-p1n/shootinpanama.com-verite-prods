...
(function () {
  ...
  var ES = {
    ...
    // ── Home · hero ──
    "Shoot In Panama · Panama City": "Shoot In Panama · Ciudad de Panamá",
    "Panama. Where your next": "Panamá. Donde vive tu",
    "production lives.": "próxima producción.",
    "For over 30 years Ricardo Barria, Shoot In Panama and sister company Verite Producciones have been the ground team international productions trust in Panama — handling crew, permits, compliance and logistics so your team arrives ready to shoot, not ready to problem-solve.": "Desde hace más de 30 años Ricardo Barria, Shoot In Panama y su empresa hermana Verite Producciones son el equipo en tierra en el que confían las producciones internacionales en Panamá — gestionamos crew, permisos, cumplimiento y logística para que tu equipo llegue listo para rodar, no para resolver problemas.",
    ...
    "Shoot": "Rodaje",
    "365 days.": "365 días.",
    "(366 days in leap years)": "(366 en año bisiesto)",
    ...
    // ── Essay: tropical weather ──
    "Weather & Logistics": "Clima y logística",
    "Tropical Weather Forecasting: The Panama Field Guide": "Pronóstico del clima tropical: la guía de campo de Panamá",
    "Hurricane-safe latitude, two-ocean microclimates and 18-foot Pacific tides — plus why the smart 1st AD schedules hero shots for the hour right after the downpour.": "Latitud a salvo de huracanes, microclimas entre dos océanos y mareas del Pacífico de hasta 18 pies — y por qué el 1st AD astuto agenda los hero shots para la hora justo después del aguacero.",
    "Tropical weather,": "El clima tropical,",
    "the field guide.": "la guía de campo.",
    "If you're line producing in Central America, Panama is about as close to a geographical jackpot as it gets. Nestled safely south of the Caribbean hurricane belt, the S-shaped isthmus spares unit managers the nightmare of Category 5 evacuations, island-flattening monsoons, or destroyed exterior builds.": "Si estás haciendo line production en Centroamérica, Panamá es casi un premio gordo geográfico. Ubicado a salvo al sur del cinturón de huracanes del Caribe, el istmo en forma de S le ahorra a los unit managers la pesadilla de evacuaciones categoría 5, monzones que arrasan islas o sets de exteriores destruidos.",
    "Panama's unique geography — a narrow strip of land sandwiched between two oceans — comes with its own atmospheric call sheet: rapid microclimates, torrential midday downpours, and one spectacular cinematic payoff. First, the advantage.": "La geografía única de Panamá — una franja angosta de tierra entre dos océanos — trae su propio call sheet atmosférico: microclimas rápidos, aguaceros torrenciales de mediodía y una recompensa cinematográfica espectacular. Primero, la ventaja.",
    "The hurricane \"safe zone\"": "La \"zona segura\" de huracanes",
    "Sitting around 7–9°N latitude, Panama lacks the Coriolis effect required to spin up major tropical cyclones. For production insurance and scheduling this is massive: you get tropical aesthetics without the catastrophic risk of season-canceling storms.": "Ubicada alrededor de los 7–9°N de latitud, Panamá carece del efecto Coriolis necesario para formar ciclones tropicales mayores. Para el seguro de producción y la programación esto es enorme: obtienes la estética tropical sin el riesgo catastrófico de tormentas que cancelan la temporada.",
    "Two oceans in one day": "Dos océanos en un día",
    "Because the country is so narrow, you can shoot a Caribbean sunrise and a Pacific sunset on the same day. That oceanic sandwich also creates rapid microclimates: the Pacific side (Panama City, Azuero) runs drier, while the Caribbean side (Colón, Bocas del Toro) and the interior highlands (Boquete) keep their own distinct weather clocks.": "Como el país es tan angosto, puedes rodar un amanecer en el Caribe y un atardecer en el Pacífico el mismo día. Ese sándwich oceánico también crea microclimas rápidos: el lado Pacífico (Ciudad de Panamá, Azuero) es más seco, mientras que el lado Caribe (Colón, Bocas del Toro) y las tierras altas del interior (Boquete) mantienen su propio reloj de clima.",
    "Extreme Pacific tides": "Mareas extremas del Pacífico",
    "Not a sky event, but ocean logistics here mean checking tidal charts alongside the rain radar. The Pacific side swings up to 18 feet, which reshapes beach access, marine staging and shoreline camera placements every six hours.": "No es un evento del cielo, pero la logística oceánica aquí implica revisar las tablas de mareas junto al radar de lluvia. El lado Pacífico oscila hasta 18 pies, lo que reconfigura el acceso a la playa, el marine staging y las posiciones de cámara en la orilla cada seis horas.",
    "The Panama golden rule: never call a wrapped day just because a 2:30 PM tropical downpour turns basecamp into a lake.": "La regla de oro de Panamá: nunca des por terminado el día solo porque un aguacero tropical de las 2:30 PM convierte el basecamp en un lago.",
    "The midday blitz": "El blitz del mediodía",
    "During the wet season (invierno, roughly May to December), intense solar heating builds moisture by early afternoon and unleashes sudden, heavy convective rain that can stall shooting for 45 to 60 minutes. Logistics teams keep heavy-duty tarps, raised cable runs and quick-shelter protocols on standby.": "Durante la estación lluviosa (invierno, aproximadamente de mayo a diciembre), el intenso calentamiento solar acumula humedad a primera hora de la tarde y desata una lluvia convectiva súbita y fuerte que puede detener el rodaje de 45 a 60 minutos. Los equipos de logística mantienen a la mano lonas de alto rendimiento, tendidos de cable elevados y protocolos de refugio rápido.",
    "The post-downpour magic hour": "La magic hour después del aguacero",
    "Here is where Panama repays your patience. The rain acts as an atmospheric filter, washing away dust, haze and heat shimmer. Once the cell passes, the sky opens into dramatic cloud formations with ultra-clear air, high-contrast light and wet ground surfaces that give exteriors an instant high-production-value sheen.": "Aquí es donde Panamá recompensa tu paciencia. La lluvia actúa como un filtro atmosférico, barriendo el polvo, la bruma y el temblor de calor. Una vez que pasa la celda, el cielo se abre en formaciones de nubes dramáticas con aire ultra claro, luz de alto contraste y superficies mojadas que le dan a los exteriores un brillo instantáneo de alto valor de producción.",
    "The logistical payoff": "La recompensa logística",
    "The smart 1st AD schedules \"wet-look\" hero shots, drone sweeps and dramatic wide angles for the hour immediately after a storm. While standard productions run for cover, a Panama-savvy crew — Verite Producciones, of course — holds talent in hair and makeup, ready to roll the second the sun breaks back through.": "El 1st AD astuto agenda los hero shots con \"wet-look\", las pasadas de drone y los planos generales dramáticos para la hora inmediatamente después de una tormenta. Mientras las producciones comunes corren a cubrirse, un crew que conoce Panamá — Verite Producciones, por supuesto — mantiene al talento en maquillaje y peinado, listo para rodar en el segundo en que el sol vuelve a salir.",

    // ── Essay / card: "A Man, a Plan, a Canal" — content mirrors Ricardo's source doc closely.
    // Title fragments left untranslated on purpose — graceful English fallback. ──
    "About Verite": "Sobre Verite",
    "The full picture — the Hub of the Americas, where Panama has stood in on screen, the rebate's fine print, and the client list behind 30+ years in production.": "El panorama completo — el Hub de las Américas, dónde Panamá ha doblado en pantalla, la letra chica del rebate, y la lista de clientes detrás de más de 30 años en producción.",
    "Many countries in the region offer beaches, rainforests, mountains, modern cities and bucolic villages. Panama, aside from all these, also offers a premium no other country in the region can: it's a recognized air, maritime and communications hub for the region. Literally, the Hub of the Americas.": "Muchos países de la región ofrecen playas, selvas, montañas, ciudades modernas y pueblos bucólicos. Panamá, además de todo esto, ofrece algo que ningún otro país de la región puede: es un hub aéreo, marítimo y de comunicaciones reconocido para la región. Literalmente, el Hub de las Américas.",
    "Hub of the Americas": "Hub de las Américas",
    "Panama's location, at the center of the American continent, connects 90+ cities in Europe and America with daily direct non-stop flights. Five percent of all global maritime trade navigates through here, with weekly services from major US ports as well as South America, Asia and Europe. Big data zips through Panama's intercontinental undersea cable systems, allowing for true broadband interconnection — so whatever can't be sourced locally can be transported here, fast. And Panama's modern international banking system is pegged to the US dollar, a fact that not only avoids messy currency exchanges but also guarantees safe and expeditious processing of money transfers.": "La ubicación de Panamá, en el centro del continente americano, conecta más de 90 ciudades de Europa y América con vuelos directos diarios. Cinco por ciento de todo el comercio marítimo mundial navega por aquí, con servicios semanales desde los principales puertos de EE. UU., además de Sudamérica, Asia y Europa. El big data circula por los sistemas de cable submarino intercontinental de Panamá, permitiendo banda ancha real — así que lo que no se pueda conseguir localmente se puede transportar aquí, rápido. Y el moderno sistema bancario internacional de Panamá está anclado al dólar estadounidense, lo cual no solo evita el cambio de divisas sino que garantiza transferencias de dinero seguras y expeditas.",
    "This famous palindrome once described Panama to the world as the site of the famous maritime shortcut. But those days are long gone — Panama has become a favored location for reality shows since the format became popular. Bocas del Toro, Pearl Islands, Pedasí, Chiriquí and many other Panamanian locations have hosted Amazing Race (USA, Canada, Australia and Finland versions), Survivor (both the original and its franchises), MTV's The Challenge — which has made Panama its temporary home on three occasions — many Discovery Channel adventure shows including the latest Survive the Raft, NBC's Deal or No Deal Island (2023/2024), and a slew of YouTubers' content, among them Mr. Beast and N3ON.": "Este famoso palíndromo describió alguna vez a Panamá ante el mundo como el sitio del famoso atajo marítimo. Pero esos días quedaron atrás — Panamá se ha convertido en una locación favorita para los reality shows desde que el formato se popularizó. Bocas del Toro, las Islas Perlas, Pedasí, Chiriquí y muchas otras locaciones panameñas han sido sede de Amazing Race (versiones de EE. UU., Canadá, Australia y Finlandia), Survivor (tanto el original como sus franquicias), The Challenge de MTV — que ha hecho de Panamá su hogar temporal en tres ocasiones —, muchos programas de aventura de Discovery Channel incluyendo el más reciente Survive the Raft, Deal or No Deal Island de NBC (2023/2024), y una serie de contenido de YouTubers, entre ellos Mr. Beast y N3ON.",
    "Panama's versatility as a location has been proven widely. The Bond franchise used Panama to play as Bolivia and Haiti in Quantum of Solace. The Suicide Squad used parts of a derelict area of Colón city to be the South American island of Corto Maltese; in Prison Break, Panama plays as itself, just as in Contraband.": "La versatilidad de Panamá como locación ha quedado ampliamente demostrada. La franquicia de Bond usó Panamá para representar a Bolivia y Haití en Quantum of Solace. The Suicide Squad usó partes de una zona abandonada de la ciudad de Colón para representar la isla sudamericana de Corto Maltese; en Prison Break, Panamá se interpreta a sí misma, igual que en Contraband.",
    "Panama as a location is very versatile and efficient. Beaches, deserted islands, mountains, tropical jungle, raging rivers and waterfalls, luxurious houses, barracks, former military bases and a modern and cosmopolitan capital city with all its barrios and urban niches make Panama a place for efficient production.": "Panamá como locación es muy versátil y eficiente. Playas, islas desiertas, montañas, selva tropical, ríos y cascadas embravecidas, casas lujosas, cuarteles, antiguas bases militares y una capital moderna y cosmopolita con todos sus barrios y nichos urbanos hacen de Panamá un lugar para la producción eficiente.",
    "While Panama struggles with the rest of the world on matters of climate change, it proudly is, along with Bhutan and Suriname, one of three carbon-negative countries in the world. We encourage productions to reduce their carbon footprint by eliminating (or minimizing) the use of one-time plastic bottles. Panama has laws that protect its flora and fauna, and productions are expected to observe these regulations.": "Aunque Panamá enfrenta, junto con el resto del mundo, los retos del cambio climático, es orgullosamente uno de solo tres países carbono-negativos del mundo, junto con Bután y Surinam. Animamos a las producciones a reducir su huella de carbono eliminando (o minimizando) el uso de botellas plásticas desechables. Panamá tiene leyes que protegen su flora y fauna, y se espera que las producciones las respeten.",
    "Climate": "Clima",
    "Panama's privileged geographic position keeps it away from most of the tropical weather associated with the Caribbean: mainly hurricanes. Panama's weather oscillates between dry and wet… very wet (that's why they call it the rain-forest!).": "La posición geográfica privilegiada de Panamá la mantiene alejada de la mayoría del clima tropical asociado al Caribe: principalmente los huracanes. El clima de Panamá oscila entre seco y húmedo… muy húmedo (¡por algo le dicen selva tropical!).",
    "Panama's dry season goes from late December to April. Rains begin in early May and go on, with increasing intensity, up to mid-December (with September and October usually being the wettest months). Downpours are usually fast and furious, and can easily transform from a dark, somber sky to a bright and sunny day, with the accompanying magic-hour sunset. Our proximity to the equator means our days are almost an even 12 hours of daylight vs. 12 hours of night (no daylight saving time here). Temperatures oscillate between the upper 20s and mid-30s Celsius, with humidity in the mid-80s.": "La estación seca de Panamá va de finales de diciembre a abril. Las lluvias comienzan a principios de mayo y continúan, con intensidad creciente, hasta mediados de diciembre (siendo septiembre y octubre usualmente los meses más lluviosos). Los aguaceros suelen ser rápidos e intensos, y pueden transformar fácilmente un cielo oscuro y sombrío en un día soleado, con su correspondiente atardecer de magic hour. Nuestra cercanía al ecuador hace que nuestros días tengan casi exactamente 12 horas de luz frente a 12 horas de noche (sin horario de verano aquí). Las temperaturas oscilan entre los 27 y los 35°C, con una humedad alrededor del 80-85%.",
    "Tax breaks and incentives": "Beneficios fiscales e incentivos",
    "Panama offers a 25% cash rebate incentive on a minimum \"in country\" expenditure of $500,000 USD. Applying for this incentive requires partnering with a local licensed production company that is registered both with the Ministry of Culture and the Ministry of Commerce and Industries. Law 16 also grants the visiting production customs exemptions plus a one-window stop for processing of both customs and labor permits. All equipment imported temporarily for the production is exempt of any duties.": "Panamá ofrece un incentivo de reembolso en efectivo del 25% sobre un gasto mínimo \"en el país\" de $500,000 USD. Para aplicar a este incentivo es necesario asociarse con una empresa de producción local licenciada y registrada tanto ante el Ministerio de Cultura como ante el Ministerio de Comercio e Industrias. La Ley 16 también otorga a la producción visitante exenciones de aduana y una ventanilla única para trámites de aduana y permisos laborales. Todo equipo importado temporalmente para la producción está exento de aranceles.",
    "Important: all documentation for the cash rebate must be prepared and presented by a Certified Public Accountant, and submitted to the Ministry of Commerce and Industries by legal counsel, following guidelines issued by the fiscal authorities.": "Importante: toda la documentación para el reembolso en efectivo debe ser preparada y presentada por un Contador Público Autorizado, y presentada ante el Ministerio de Comercio e Industrias por asesoría legal, siguiendo los lineamientos emitidos por las autoridades fiscales.",
    "Notes and local fun facts": "Notas y datos curiosos locales",
    "The Panama Film Commission charges $150 per week of production (initiating with preproduction). This fee can also be applied to the 25% cash back.": "La Comisión de Cine de Panamá cobra $150 por semana de producción (a partir de la preproducción). Esta tarifa también puede aplicarse al 25% de reembolso.",
    "Panama's time zone is GMT-5 (no daylight saving time).": "El huso horario de Panamá es GMT-5 (sin horario de verano).",
    "Local sales tax is 7% on all goods and services.": "El impuesto de ventas local es del 7% sobre todos los bienes y servicios.",
    "Power in Panama is 120V with Edison-type plugs (same as the USA).": "La corriente en Panamá es de 120V con enchufes tipo Edison (igual que en EE. UU.).",
    "Must-know expression: ¿Qué xopa? = What's up?": "Expresión que debes saber: ¿Qué xopa? = ¿Qué tal?",
    "Local currency is the balboa, 1:1 parity with the US dollar (only available in metal) — dollar bills circulate freely and legally.": "La moneda local es el balboa, con paridad 1:1 con el dólar estadounidense (solo disponible en metálico) — los billetes de dólar circulan libre y legalmente.",
    "Before you go back home: drink some seco, Ron Abuelo or a local craft brew, eat some patacones, slurp a raspao, taste Panamanian coffee, try a mafa and pesada de nance, and have \"Chinese breakfast\" — uniquely Panamanian, regardless of what it's called — on any given Sunday.": "Antes de volver a casa: toma un seco, Ron Abuelo o una cerveza artesanal local, come unos patacones, saborea un raspao, prueba el café panameño, prueba una mafa y pesada de nance, y disfruta el \"desayuno chino\" — algo único de Panamá, sin importar cómo se llame — cualquier domingo.",
    "And don't forget to visit the Panama Canal. It never ceases to amaze.": "Y no olvides visitar el Canal de Panamá. Nunca deja de sorprender.",
    "Something about us": "Algo sobre nosotros",
    "Established in 1993, Verite Producciones is dedicated to high-value advertising, corporate, industrial and television production, as well as production services for visiting production companies.": "Fundada en 1993, Verite Producciones se dedica a producción publicitaria, corporativa, industrial y televisiva de alto valor, así como a servicios de producción para empresas de producción visitantes.",
    "We offer the visitor production services with skilled bilingual personnel for all logistics and technical needs, location scouting, transportation (marine/air/land), legal services and catering, amongst others. Our legal team is prepared to offer advice and process the benefits and incentives offered by Panama's Film Law 16, enacted in April 2012.": "Ofrecemos al visitante servicios de producción con personal bilingüe capacitado para todas las necesidades logísticas y técnicas, scouting de locaciones, transporte (marítimo/aéreo/terrestre), servicios legales y catering, entre otros. Nuestro equipo legal está preparado para asesorar y tramitar los beneficios e incentivos que ofrece la Ley de Cine 16 de Panamá, promulgada en abril de 2012.",
    "Verite Producciones' international client list includes Bunim-Murray Productions, Discovery Channel, FOX Television, Critical Content, Bright Bay Creative LLC, Mr. Beast LLC, E! Entertainment, The Today Show, World Race Productions and nearly all local advertising agencies.": "La lista de clientes internacionales de Verite Producciones incluye a Bunim-Murray Productions, Discovery Channel, FOX Television, Critical Content, Bright Bay Creative LLC, Mr. Beast LLC, E! Entertainment, The Today Show, World Race Productions y prácticamente todas las agencias de publicidad locales.",

...
export const ROUTES = [
  {
    ...
    en: {
      ...
      desc: 'Ricardo Barria: 30 years of shooting in Panama with Shoot In Panama and Verite Producciones, International Quorum of Motion Picture Producers.',
      name: 'Home'
    },
    es: {
      title: 'Servicios de Producción de Cine en Panamá | Shoot In Panama',
      desc: 'Ricardo Barria: 30 años rodando en Panamá con Shoot In Panama y Verite Producciones, International Quorum of Motion Picture Producers.',
      name: 'Inicio'
    }
  },
  {
